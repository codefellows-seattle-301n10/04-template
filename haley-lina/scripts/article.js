...
// The .sort() method is taking 2 arguments hence the parentheses, whereas the .forEach() methods only take one argument, so the parentheses is optional with one argument.
