...
// becuase the sort is comparing two valies to place them in the correct order and the forEach is not comparing values.
// Because there are two values in (a,b)
